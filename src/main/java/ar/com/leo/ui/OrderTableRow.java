...
public class OrderTableRow {
    ...
    private final OrdenML orden;

    public OrderTableRow(boolean selected, String zone, String sku, String productDescription,
                         String quantity, String status, String slaDate, OrdenML orden) {
    ...
    public OrdenML getOrden() { return orden; }
}
